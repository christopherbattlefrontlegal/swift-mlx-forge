      ...
      <Field name="throttleChatNode">
        {() => (
          <>
            ...
            <HelperMessage>
              Throttles the stream of chat node data into Forge. Increasing this can improve performance. Set to 0 to
              disable.
            </HelperMessage>
          </>
        )}
...
export const UpdatesSettingsPage: FC = () => {
  ...
  return (
    <div css={fields}>
      <p>
        You are currently on <strong>Forge Graph {currentVersion}</strong>
      </p>
