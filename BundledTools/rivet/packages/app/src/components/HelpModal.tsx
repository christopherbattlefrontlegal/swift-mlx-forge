        ...
        <Modal onClose={() => setHelpModalOpen(false)}>
          ...
          <ModalBody>
            <div css={styles}>
              ...
              <p>
                The upstream documentation covers every node and explains how to build and integrate graphs.
              </p>
              <h2>
              ...
              <h2>
                <a href="https://twitter.com/rivet_ts" target="_blank" rel="noreferrer">
                  <TwitterIcon /> Upstream Project on X
                </a>
              </h2>
              <p>Join discussions about the upstream graph engine on X.</p>
              <h2>
                {' '}
                <a href="https://www.youtube.com/channel/UCzCPXL6k7kjr26rhfWNmbfA" target="_blank" rel="noreferrer">
                  <img src={YoutubeIcon} alt="YouTube Logo" /> Upstream YouTube
                </a>
              </h2>
              <p>The upstream channel contains graph tutorials, examples, and workflow ideas.</p>
            </div>
          </ModalBody>
          <ModalFooter>
