...
export const MCPConfigModal: FC<{
  ...
  return (<Modal onClose={onClose}>
        ...
        <ModalBody>
          ...
          >
            <p>
              To use local MCP servers with your Forge project, add the MCP configuration in the field below.
              The configuration must be a JSON parsable string.
              The MCP configuration entered here will be saved with the Forge project file.
            </p>
